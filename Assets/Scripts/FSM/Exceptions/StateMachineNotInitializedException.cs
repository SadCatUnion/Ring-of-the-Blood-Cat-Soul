...
namespace FSM.Exceptions
{
    ...
    {
        private static string Format(string context, string problem, string solution)
        {
            if (problem == null)
			{
        ...
        public StateMachineNotInitializedException(string context = null, string problem = null, string solution = null)
            : base(Format(context, problem, solution))
        {
        }
    }
}