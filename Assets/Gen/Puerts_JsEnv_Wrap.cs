...
{"jsEnvs", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_jsEnvs, Setter = S_jsEnvs} }
                ...
                {
                    {"OnJsEnvCreate", new Puerts.PropertyRegisterInfo(){ IsStatic = true } },
{"OnJsEnvDispose", new Puerts.PropertyRegisterInfo(){ IsStatic = true } },
{"debugPort", new Puerts.PropertyRegisterInfo(){ IsStatic = false } }
                }
            };
        }
